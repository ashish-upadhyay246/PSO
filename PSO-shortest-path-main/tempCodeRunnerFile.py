...
def plot_graph(best_location): #plot the final graph
    plt.close("all")
...
DIM = 16 #points to be considered in the final path, higher the number = better curves = higher computational compexity.
START = ob.Point(0, 0)
END = ob.Point(18, 20)
